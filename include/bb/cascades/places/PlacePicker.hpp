...
class QT_CASCADES_EXPORT BB_CASCADES_PLACES_EXPORT PlacePicker: public bb::cascades::CustomControl
{
public:
   PlacePicker(QObject* parent = 0);
   virtual ~PlacePicker();
   MOCK_METHOD0(show, bb::cascades::places::SelectedPlace* ());
#endif
