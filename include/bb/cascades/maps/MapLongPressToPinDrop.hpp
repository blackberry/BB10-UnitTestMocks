...
class QT_CASCADES_EXPORT BB_CASCADES_MAPS_EXPORT MapLongPressToPinDrop : public QObject {
public:
        MapLongPressToPinDrop( MapView* map );
        virtual ~MapLongPressToPinDrop();
        MOCK_METHOD1(pinCreated, void ( const QString& id ));
};
} 
} 
} 
