...
class TranslateTransition : public AbstractTransition {
public:
    TranslateTransition() { }
...
public:
    typedef TranslateTransition ThisClass;  
    ...
    public:
        Builder() : TBuilder<Builder, TranslateTransition>(new TranslateTransition()) {}
    };
